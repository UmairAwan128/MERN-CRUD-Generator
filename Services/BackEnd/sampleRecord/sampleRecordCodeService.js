...
class sampleRecordCodeService {
  ...
  GetSampleRecordFileCode(scheema) {
    ...
    appFileCode += this.getClassAndConstructorCode(); // render() and state
    appFileCode += this.getSampleRecordCode(scheema);
    appFileCode += this.getRemainsAndExports(); // all close braces and exports
    return appFileCode;
  }
