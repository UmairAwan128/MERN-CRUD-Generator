...
To generate your MERN CRUD App the only thing you need is a json schema file in a specific format, a sample schema which uses all the features of MERN CRUD Generator is attached at the bottom of the page here [Sample Schema File](https://www.npmjs.com/package/mern-crud-generator#sample-schema-file), first in any directory of your computer, create a file named app.json with json provided in sample schema file, then you just need to run this command.

```sh
npx mern-crud-generator app.json
```
